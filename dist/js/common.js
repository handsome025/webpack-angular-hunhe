...
/* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_DEFINE_RESULT__;;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
...
/* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_DEFINE_RESULT__;;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
	...
	common.loadCommon = function(container,pagename){
		var html = !(function webpackMissingModule() { var e = new Error("Cannot find module \"../../pages\""); e.code = 'MODULE_NOT_FOUND';; throw e; }())
		var js = !(function webpackMissingModule() { var e = new Error("Cannot find module \"../../pages\""); e.code = 'MODULE_NOT_FOUND';; throw e; }())
...
/* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_DEFINE_RESULT__;;!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
	__webpack_require__(7)
	var uRequest = __webpack_require__(11);
	var uWebApi = {}
...
/* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_DEFINE_RESULT__;;!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
		...
		$.ajax(options).always(function () {
			...
			if (res.success) {
				...
				if(res.Message == '已拒绝为此请求授权。'){
					Site.alert('登陆超时，请重新登录',function(){
	 ...
	 * @returns {*}
	 */
	uRequest.contentPost2 = function (url, data, Authorization) {
		return uRequest.ajax({
			type: 'POST',
			url: url,
			data: data,
	 ...
	 * @returns {*}
	 */
	uRequest.get2 = function (url, data, Authorization) {
		return uRequest.ajax({
			type: 'GET',
			url: url,
			data: data,
